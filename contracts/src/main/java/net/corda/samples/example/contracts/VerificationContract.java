 ...
 */
public class VerificationContract implements Contract {
    public static final String ID = "net.corda.samples.example.contracts.VerificationContract";
    ...
    public void verify(LedgerTransaction tx) {
        ...
        requireThat(require -> {
            ...
            final VerificationState out = tx.outputsOfType(VerificationState.class).get(0);
            require.using("The Sender and the Receiver cannot be the same entity.",
                    !out.getSender().equals(out.getRecipient()));
