 ...
 *
 * This contracts enforces rules regarding the creation of a valid [PaymentState], which in turn encapsulates an [IOU].
 *
...
public class PaymentContract implements Contract {
    public static final String ID = "net.corda.samples.example.contracts.PaymentContract";
